              ...
              <ColumnContentLg>
                <div>
                  ...
                  <p>
                    ...
                    purchasing function to boost profitability. In alignment
                    with their requirements, I initiated the project.
                  </p>
                  <p className="caption">
                  ...
                  <div className="list">
                    ...
                    <p>
                      • Ensure that the presence of the component doesn’t
              ...
              <FullWidthWrapper>
                ...
                <ColumnLg>
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        To prevent issues from becoming permanent, it’s crucial
                        to start by exploring the layout and space to meet the
                        necessary requirements. This involves brainstorming
                        ideas, implementing them, and then analyzing them with
                        teams or collaborators to identify any unclear factors.
                      </p>
                      <p>
                        Indeed, the iterative process I practiced helped uncover
                        and address potential problems. It’s a proactive
                        approach to identifying issues and finding solutions to
                        them, ensuring a smoother and more effective project
                        development.
                      </p>
                    </div>
                  </ColumnContentLg>
                  ...
                  <ColumnContentLg>
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        through mutual discussion can help address this
                        challenge.
                      </p>
                    </div>
                  </ColumnContentLg>
              ...
              <FullWidthWrapper>
                ...
                <ColumnLg>
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        After the iterative process, the clarification of
                        various factors greatly contributed to our
                        decision-making.
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        associate this function with product pages and
                        collections became a crucial necessity and also, The
                        analysis of Snackbar results demonstrated a consistent
                        increase in the conversion rate, as indicated in monthly
                        reports.
                      </p>
                    </div>
                  </ColumnContentLg>
              ...
              <ResearchInsight>
                <ColumnContentSm>
                  <div>
                    ...
                    <p>
                      The website had previously assigned a modal window to
                      notify customers who hadn’t subscribed.
                    </p>
                    <p>
                      Initially, when I proposed the first ideas of modal
                      windows used in this project, there was concern about
                      whether this was too inhibited when had proposed the first
                      ideas of modal windows used in this project.
                    </p>
                    <p>
                      However, after considering various options, I decided to
                      incorporate static animations that could be used flexibly.
                      While creative implementation is essential and enjoyable,
                      it must also account for the limits and requirements of
                      the project, and balancing creative implementation with
              ...
              <ColumnContentLg>
                <div>
                  ...
                  <p>
                    ...
                    and cross-selling based on our analysis, aiming for
                    increased engagement and ultimately driving customer
                    purchases.
                  </p>
                  <p className="caption">
                    Project Requirements and Responsibilities:
                  ...
                  <div className="list">
                    ...
                    <p>
                      • Creating designs that support intuitive user
                  ...
                  <p>
                    <p className="caption-inner">Cross-selling</p>Cross-selling
                    is a sales technique to get the customer to spend more money
                    by adding more products from other categories than the
                    product being viewed or purchased.
                  </p>
                  <p>
              ...
              <FullWidthWrapper>
                ...
                <ColumnLg>
                  <ColumnContentLg>
                    <div>
                      <h2>
                        Integrating design elements for a logical user
                        experience
                      </h2>
                    </div>
                    <div>
                      <p>
                        The project required an effective and intuitive
                        component to support profitability so, to increase
                        engagement, I applied pricing psychology and designed
                        fundamental components in a logical manner.
                      </p>
                      <p>
                        Psychology alone may not solve all problems, but
                        integrating psychological concepts can guide effective
                        A/B testing to enhance a product.
                      </p>
                    </div>
                  </ColumnContentLg>
                </ColumnLg>
                  ...
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        ...
                        filled gradually with a blue color as indicated left
                        side.
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        selects “add to cart,” regardless of when they added
                        them. This ensures that the user stays on the page,
              ...
              <FullWidthWrapper>
                ...
                <ColumnLg>
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        In conclusion, addressing challenges comprehensively was
                        a crucial process in this project. The outcome
                        contributed to improving key metrics, particularly in
                      ...
                      <p>
                        Indeed, considering ease of optimization post-analysis
                        is crucial for efficient time management and overall
                        project success.
                      </p>
                    </div>
                  </ColumnContentLg>
              ...
              <ResearchInsight>
                <ColumnContentSm>
                  <div>
                    ...
                    <p>
                      It’s essential to pre-make decisions based on user needs
                      and wants before moving forward with the implementation.
                      Through a systematic approach, I am confident that the
                      products will be robust and cater to our specific
                      requirements.
                    </p>
                  </div>
                </ColumnContentSm>
            ...
            <ContentInfoContainer>
              <ColumnContentLg>
                <div>
                  ...
                  <p>
                    Analyzing metrics over time, my teams identified
                    opportunities to enhance customer lifetime value. The
                    analysis highlighted areas for improvement on product pages,
                    prompting me to conceptualize ways to unlock their
                  ...
                  <p>
                    ...
                    customers so The key lies in the designer’s ability to
                    create a thoughtful and considerate page that takes various
                  ...
                  <div className="list">
                    ...
                    <p>
                      • Consciously integrate profitable elements and an
                      aesthetic focus
                    </p>
                    <p>
                    ...
                    <p>
                      • Presenting prototypes to incorporate new ideas
                      discovered during the project’s progression
                    </p>
                  </div>
                </div>
              </ColumnContentLg>
              ...
              <FullWidthWrapper>
                ...
                <ColumnLg>
                  <ColumnContentLgMd>
                    <div>
                      <h2>
                        Integrating requirements seamlessly into the design
                      </h2>
                    </div>
                    <div>
                      <p>
                        ...
                        section, following these guidelines, three prototypes
                        were created.
                      </p>
                      <p>
                        <p style={{ color: "#010606" }}>Video:</p>I incorporated
                        the video in the hero section, keeping in mind our
                        discussion about the importance of exercising caution
                        for appropriateness, preserving a seamless user
                        experience with clear guidelines based on requirements,
                        and through that, recognizing the importance of
                ...
                <ColumnContentMd>
                  <div>
                    ...
                    <p>
                      ...
                      inappropriate layout affecting user experience.
                      Considering the analysis, replacing organic text with
                      icons and a thoughtful redesign have clarified and
                  ...
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        ...
                        maintained consistency with the defined design,
                        resulting in improved communication with customers.
                      </p>
                    </div>
                  </ColumnContentLg>
                </ColumnLg>
                  ...
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        ...
                        purposes, we took to hide the reviews section and
                        overlay it, deviating from the theoretical approach.
                      </p>
                    </div>
                  </ColumnContentLg>
                </ColumnLg>
            ...
            <FullWidthContainer>
                  ...
                  <ColumnContentLgMd>
                    ...
                    <div>
                      <p>
                        ...
                        providing additional avenues for product purchases.
                        We’ve been implementing a website function to help users
                        determine their skin type, a significant contributor to
                        enhancing user engagement.
                      </p>
                      <p>
                        Additionally, the Product Detail Page (PDP) features the
                        same function, although it was not initially optimized
                        for a seamless user experience tied to the purchase and
              ...
              <ResearchInsight>
                <ColumnContentMd>
                  <div>
                    <p>
                      Ensure alignment with UI design standards, incorporate
                      clear call-to-action (CTA) elements, and display the
                      included products prominently within the modal window
                      components.
                    </p>
                  </div>
                </ColumnContentMd>
                  ...
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        ...
                        potentially boost profitability. Recognizing the need
                        for a valid reason, I meticulously crafted this
                        component for proposing to the team as it could present
              ...
              <FullWidthWrapper>
                ...
                <ColumnLg>
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        In the final decision, we opted to integrate a sticky
                        CTA that smoothly hides when it’s not in focus on
                        essential elements. Additionally, the CTA has been
                        transformed into a distinct section, enhancing the
                        navigation of the eye trajectory.
                      </p>
                      <p>
                ...
                <ColumnContentMd>
                  <div>
                    <p>
                      ...
                      which directly links to the purchase. This will occur if
                      the page or app fulfills crystal-clear conditions,
                      enclosing all relevant factors.
                    </p>
                  </div>
                </ColumnContentMd>
              </ResearchInsight>
