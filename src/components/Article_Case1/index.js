    ...
    <CaseContainer id="case1">
      ...
      >
        ...
        <CaseWrapper>
          ...
          <CaseCaption>Flow sheet.</CaseCaption>
          <Case_h3>The Goal</Case_h3>
          <Case_p>
          ...
          <CaseCaption style={{ marginBottom: "3rem" }}>
          ...
          <CaseCaption>Images for website journey map.</CaseCaption>
          <Case_h3>My role</Case_h3>
          <Case_p>
          ...
          <Case_h3 style={{ marginTop: "5rem" }}>Challenge</Case_h3>
          <Case_p>
          ...
          <Case_h3 style={{ marginTop: "5rem" }}>Solution</Case_h3>
          <Case_p>
          ...
          <Case_h3 style={{ marginTop: "5rem" }}>Final thoughts</Case_h3>
          <Case_p>
          ...
          <CaseCaption>Finalized mobile images.</CaseCaption>
          <div style={{ textAlign: "center" }}>
            <ImageDown src={DarumaArticle_6} id="" />
          </div>
          <Case_h3 style={{ marginTop: "1.5rem" }}>Responsibilities</Case_h3>
          <Case_p>
          ...
          <Case_h3 style={{ marginTop: "5rem" }}>The outcome</Case_h3>
          <Case_p>
          ...
          <Feedback>
            ...
            <Case_p style={{ fontSize: "14px", lineHeight: "1.5" }}>
