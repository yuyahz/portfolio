                  ...
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        ...
                        challenges, with a specific focus on managing chips
                        after applying the filter. The process was approached
                        from bottom to up.
                      </p>
                      <p>
                      ...
                      <p>
                        Additionally, it facilitates the utilization of space
                        for product cards, effectively minimizing time-consuming
                        interactions. The best solution might not have been
                        found had it not been for the Phase 3 process.
                      </p>
                    </div>
                  </ColumnContentLg>
                </ColumnLg>
                  ...
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        ...
                        conducting practice, I refined the chip designs. The
                        chips are grouped by different colors.
                      </p>
                      <p>
                  ...
                  <ColumnContentLg>
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        aspect, the concept remains the same; however, it
                        requires a different approach to UX and UI design,
                        especially considering that over 70% of our users employ
                        mobile devices. I dedicated significant effort to mobile
                        design.
                      </p>
                      <p>
              ...
              <ResearchInsight>
                <ColumnContentSm>
                  <div>
                    ...
                    <p>
                      A valuable insight gained is that sorting through
                      filtering is a crucial and core element in improving user
                      experience.
                    </p>
                    <p>
                      It’s evident that this will further enhance the
                      integration of marketing features, ultimately contributing
              ...
              <ColumnContentLg>
                <div>
                  ...
                  <div className="list">
                    ...
                    <p>
                      • Designing an interface with the aesthetic-usability
                      effect
                    </p>
                    <p>
                    ...
                    <p>
                      • Seamless integration with Auto-Replenishment related
                      pages
                    </p>
                  </div>
                </div>
                  ...
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        ...
                        comprehensive approach from both designers and
                        developers. Following a series of meetings, I began the
                  ...
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        ...
                        elements and ensure the smooth integration of functions
                        to avoid conflict in user experience.
                      </p>
                    </div>
                  </ColumnContentLg>
                </ColumnLg>
              ...
              <FullWidthWrapper>
                ...
                <ColumnLg>
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        Through several steps, We could launch addressed
                        products that the core problem and user needs.
                        Relatively, could be carried out without a critical
                        problem but in the final steps after testing, we have
                        changed a couple of UI to simplify in order to consider
                        UX enhancements.
                      </p>
                    </div>
                  </ColumnContentLg>
                ...
                <ColumnContentSm>
                  <div>
                    ...
                    <p>
                      ...
                      functionality of the entire system and impact
                      profitability.
                    </p>
                    <p>
                      This approach has been invaluable in shaping my
                      perspective.
                    </p>
                  </div>
                </ColumnContentSm>
              ...
              <ColumnContentLg>
                <div>
                  ...
                  <p>
                    ...
                    don’t directly contribute to profits, especially for a
                    company in the midst of growth. Nevertheless, I always seek
                    opportunities to create comprehensive value. The About page,
                    which consolidates history, values, and mission in one
                    place, serves as a crucial destination for users making
                    their first visit to the website and whether to purchase or
                    not. It presents an opportunity to enhance engagement, which
                    is why we chose to revamp the About page.
                  </p>
                  <p className="caption">
                    Project Requirements and Responsibilities:
                  </p>
                ...
                <ColumnLg>
                  <ColumnContentLg>
                    ...
                    <div>
                      ...
                      <p>
                        Key tasks included crafting a mission statement,
                        outlining the company’s narrative, showcasing its
                        evolution, highlighting pivotal ‘aha!’ moments,
                        clarifying the target audience, specifying the offered
                        products/services, providing examples of past clients,
                        and articulating the core values.
                      </p>
                    </div>
                  </ColumnContentLg>
                </ColumnLg>
                  ...
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        ...
                        reinforce and enhance credibility throughout this
                        project.
                      </p>
                      <p>
                        In this process, I’ve carefully curated aesthetically
                        pleasing images and crafted a consistent design to
              ...
              <FullWidthWrapper>
                ...
                <ColumnLg>
                  <ColumnContentLgMd>
                    ...
                    <div>
                      <p>
                        As I progressed with the project, focused on the
                        potential profitability of the About page. Since most
                        visitors to this page are new customers, there’s a
                        chance to turn them into a customer base with proper
                        navigation.
                      </p>
                      <p>
                        To seize this opportunity, I created clickable Free
                        Sample Kit Cards that guide users to the customer
                        application page.
                      </p>
                      <p>
                        Additionally, I designed Cards that direct users to
                        sorted collection pages based on their selected
                        categories.
                      </p>
                    </div>
                  </ColumnContentLgMd>
                ...
                <ColumnContentMd>
                  <div>
                    <p>
                      ...
                      naturally attracted to websites that incorporate
                      interactive animations, making them visually appealing.
                    </p>
                    <p>
                      As a result of thorough research, I’ve decided on the
                      parallax animation function, along with icons, simplified
                      assets, and a signature stump SVG, to create a more
                      refined UI.
                    </p>
                    <p>
                  ...
                  <ColumnContentLg>
                    ...
                    <div>
                      <p>
                        ...
                        interface design for all devices is essential. On the
                        flip side, websites lacking responsive design are often
                        viewed as subpar.
                      </p>
                      <p>
                        Keeping this in mind, I never neglected the importance
                        of this consideration, right from the project’s initial
                        stages.
                      </p>
                    </div>
                  </ColumnContentLg>
            ...
            <InsertImageContainer>
              ...
              <ColumnInsertContent>
                <p>
                  ...
                  flexibility when addressing future challenges that may not
                  ...
                  <ColumnContentLg>
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        focus on when creating an About page, and I apply
                        similar principles to other similar pages.
                      </p>
                    </div>
                  </ColumnContentLg>
                </ColumnLg>
                ...
                <ColumnContentSm>
                  <div>
                    ...
                    <p>
                      ...
                      page should be authentic, relatable, genuine,
                      approachable, distinguished, and unique.
                    </p>
                    <p>
